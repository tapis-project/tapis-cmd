...
public class TokensCreateUserToken 
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        // Create the app.
        var tokensClient = new TokensClient(props.getProperty("BASE_URL"));
        tokensClient.addDefaultHeader(TAPIS_JWT_HEADER, props.getProperty("USER_JWT"));
  
        //----------------------- ASSIGN OBO USER AND TENANT -----------------------//
        if(parms.oboTenant != null)
            DriverUtils.setOboHeaders(tokensClient, parms.oboUser, parms.oboTenant);
